Docker containers
=================
**Description:** Packaging with Debian 9

**Copyright:** 2022 Fabio Castelli (Muflone) <muflone(at)muflone.com>

**License:** GPL-3+

**Source code:** https://github.com/muflone/docker-packaging-debian-9

**Documentation:** http://www.muflone.com/docker-packaging-debian-9/
